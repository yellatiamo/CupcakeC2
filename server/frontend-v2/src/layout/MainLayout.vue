...
const titleDescriptions = {
  ...
  AD: '域渗透模块仓库：仅管理产品模块 ad 的上传、登记、推送与加载状态（不是工具列表）。',
  AdCenter: '域渗透模块仓库：仅管理产品模块 ad 的上传、登记、推送与加载状态（不是工具列表）。',
  '域渗透': '域渗透模块仓库：仅管理产品模块 ad 的上传、登记、推送与加载状态（不是工具列表）。',
  '域渗透模块': '域渗透模块仓库：仅管理产品模块 ad 的上传、登记、推送与加载状态（不是工具列表）。',
